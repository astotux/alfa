...
async def handle_start(message: Message):
    ...
    if token:
        ...
        await message.answer(
            "👋 Привет! Я — Альфа-помощник, ваш надёжный ассистент для микро-бизнеса. \nГотов поддержать вас на каждом этапе: от рутины до стратегических вопросов.\n\n"
            "🔹 Генерирую тексты: документы, посты, письма\n"
            "🔹 Объясняю законы и нормы\n"
            "🔹 Отвечаю на любые бизнес-вопросы\n"
            "🔹 Проверяю PDF и DOCX-документы на возможные ошибки и даю советы\n\n"
            "Просто напишите запрос или прикрепите PDF или DOCX!",
            reply_markup=main_kb
        )
